...
class TraCatalogo extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('pdf, datos, idiomaid, catalogoid', 'required'),
			array('idiomaid, catalogoid', 'numerical', 'integerOnly'=>true),
	...
	public function search()
	{
		...
		$criteria->compare('catalogoid',$this->catalogoid);
	 ...
	 * @return TraCatalogo the static model class
	 */

...
class PrensaController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Prensa');
	...
	{
		$model=new Prensa('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Prensa']))
			$model->attributes=$_GET['Prensa'];
	...
	{
		$model=Prensa::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Prensa $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='prensa-form')
		{
